...
export function AdminModerationView() {
  ...
  async function reauthenticate() {
    const password = window.prompt("敏感操作：请输入你自己的登录密码（验证有效期 5 分钟）");
