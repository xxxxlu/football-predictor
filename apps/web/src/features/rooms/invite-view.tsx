...
export function InviteView({ token }: { token: string }) {
  ...
  return <div className="min-h-screen"><header className="field-accent border-b rule bg-[rgb(244_241_232/85%)] backdrop-blur"><div className="mx-auto flex max-w-3xl items-center justify-between px-4 py-4 sm:px-8"><BrandMark/><Link href="/rooms" className="text-sm font-bold underline">我的房间</Link></div></header><main id="main-content" className="mx-auto max-w-3xl px-4 py-10 sm:px-8 sm:py-16">
