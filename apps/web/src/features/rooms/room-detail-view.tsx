...
import { RoomGrantsPanel } from "./room-grants-view";
...
export function RoomDetailView({ roomId }: { roomId: string }) {
  ...
  return <div className="space-y-6">
    ...
    {/* Room grants (Story 8.1): member requests, owner decides the amount; grants stay out of net points. */}
    <RoomGrantsPanel roomId={roomId} active={detail.status === "ACTIVE"} onBalanceChanged={() => void refresh()}/>
