...
import { buildInvitePath, createRoomRequest, publicRoomJoinRequest, type PublicRoomSummaryRecord, type RoomSummaryRecord, type RoomVisibility } from "./room-flow";
...
export function RoomListView() {
  ...
  async function createRoom(event: FormEvent<HTMLFormElement>) {
    ...
    const request = createRoomRequest(String(form.get("name") || ""), visibility);
    try {
