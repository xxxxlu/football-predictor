...
export const metadata: Metadata = { title: "使用规则与隐私说明", description: "PULSE 的 18+、非现金、隐私和体育数据使用边界。" };

export default function TermsPage() {
  return <div className="min-h-screen"><header className="border-b rule"><div className="mx-auto flex max-w-4xl items-center justify-between px-4 py-4 sm:px-8"><BrandMark/><Link href="/" className="text-sm font-bold hover:underline">返回首页</Link></div></header><main id="main-content" className="mx-auto max-w-4xl px-4 py-10 sm:px-8 sm:py-16"><p className="eyebrow">使用规则 · Phase 1</p><h1 className="display mt-3 text-4xl font-bold sm:text-5xl">先说清边界，再开始判断</h1><p className="mt-4 max-w-2xl leading-7 text-[var(--muted)]">本页说明产品的基本使用规则与隐私原则。创建账户，以及创建或加入房间时，系统会记录你确认的规则版本和时间。</p><div className="mt-8"><LegalBoundary/></div><div className="mt-10">
    ...
    <TermsSection number="04" title="比赛数据与封盘"><p>比赛时间和状态来自公开体育数据来源或其产品缓存；积分倍率可能延迟、暂停或被更正。只要比赛尚未开球且系统保存有来源可验证的赔率快照，用户可以按最后一次有效赔率提交；页面会展示该快照的最后更新时间。</p><p>服务端以实际开球时间、已接受的赔率版本和封盘状态作为最终提交依据。从未取得赔率、快照不可验证、比赛已开球、取消或推迟时会暂停提交。球队名称、赛事名称、统计数据及相关标识的权利归各自权利人所有；产品不因此主张所有权。</p></TermsSection>
