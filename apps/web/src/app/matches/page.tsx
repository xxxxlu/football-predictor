...
export default function MatchesPage() { return <PrivateShell title="比赛中心" description="这里仅展示产品缓存中的赛事数据；数据过期或不可用时会明确标注。"><div className="grid gap-6"><SportTabs active="FOOTBALL"/><MatchList/></div></PrivateShell>; }
