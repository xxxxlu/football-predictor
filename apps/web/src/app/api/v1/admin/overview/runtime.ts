...
import { createIdentityDatabase, PostgresOperationsOverviewRepository, PostgresOperationsRepository } from "@pulse/db";
...
export function operationsOverview() {
  if (!globalThis.__pulseOperationsOverviewRepository) {
    ...
    // budget, cache freshness and job counts keep one definition — and keep
    // re-checking OPERATIONS_HEALTH_READ on their own.
